      ...
      <FormContainer>
        ...
        <Form onSubmit={submitHandler} autoComplete="on">
          ...
          <InputGroup size="sm" className="mb-3 my-1">
            <InputGroup.Text id="inputGroup-sizing-sm">English</InputGroup.Text>
            <FormControl
              value={nameObj.en}
          ...
          <InputGroup size="sm" className="mb-3 my-1">
            <InputGroup.Text id="inputGroup-sizing-sm">Chinese</InputGroup.Text>
            <FormControl
              value={nameObj.cn}
                  ...
                  return (
                    <>
                      <InputGroup size="sm" className="mb-1 my-2" key={ind}>
                        ...
                        <FormControl value={c.color.en} readOnly />
                        <FormControl value={c.color.cn} readOnly />
                        <FormControl value={c.color.jpn} readOnly />
                        <FormControl value={c.colorHex} readOnly />
                        <FormControl
                          className="py-2"
                          type="color"
                          value={c.colorHex}
