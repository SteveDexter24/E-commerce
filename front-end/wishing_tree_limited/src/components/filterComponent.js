        ...
        <Row className="py-2 g-2">
          ...
          <Col md>
            <FloatingLabel label="Select a category">
              <Form.Select aria-label="Select a category" size="sm">
          ...
          <Col md className="d-flex align-items-center justifty-content-center">
            <Row>
              <Col>
                <h5>Filters ({filterCount})</h5>
              </Col>
              <Col className="d-flex align-items-center justifty-content-end">
